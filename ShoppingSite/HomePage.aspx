...
<body>
    <form id="form1" runat="server">
        <div style="background-color:chocolate; fill-opacity:inherit; height:30px; width:400px; margin-left:auto; margin-right:auto;">
            <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="#FFFFCC" style="text-align: center; z-index: 1; margin-left: auto; margin-right:auto; top: -1px; position: relative; left: 0px;" Text="We have got the best deals!!!!" Width="400px"></asp:Label>
        </div>
        <div style="width:600px; height:310px; margin-left:auto; margin-right:auto; margin-top:20px; position: relative; background-color:bisque" aria-dropeffect="none" >
            ...
            <asp:Label ID="Label2" runat="server" Font-Size="28pt" style="z-index: 1; left: 269px; top: 137px; position: absolute; width: 198px" Text="Rent :    RS."></asp:Label>
            ...
            <asp:Label ID="Label4" runat="server" Font-Size="28pt" style="z-index: 1; left: 266px; top: 77px; position: absolute; width: 198px" Text="Price :    RS."></asp:Label>
        ...
        <div style="height:410px; width:800px; margin-top:20px; margin-left:auto; margin-right:auto;">
        ...
        <div style="width:600px; height:300px; margin-left:auto; margin-right:auto; margin-top:20px; position: relative; background-color:beige" aria-hidden="False" >

            <asp:Button ID="Button4" runat="server" style="z-index: 1; left: 250px; top: 260px; position: absolute; width: 100px" Text="Pay" Height="30px" BackColor="#000066" Enabled="False" Font-Bold="True" ForeColor="#CCFF99" />
            <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 300px; top: 141px; position: absolute; width: 270px; text-align: left;"></asp:TextBox>

            <asp:TextBox ID="TextBox2" runat="server" style="z-index: 1; left: 300px; top: 81px; position: absolute; width: 155px" Enabled="False"></asp:TextBox>
            ...
            <asp:Label ID="Label9" runat="server" style="z-index: 1; left: 32px; top: 83px; position: absolute; width: 240px; text-align: center" Text="Enter number of months for rent :" ForeColor="#000066"></asp:Label>

            <asp:Button ID="Button5" runat="server" BackColor="#000066" BorderStyle="Ridge" Enabled="False" Font-Bold="True" ForeColor="#CCFF99" style="z-index: 1; left: 485px; top: 80px; position: absolute; width: 85px" Text="Submit" />
            <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#000066" style="z-index: 1; left: 118px; top: 205px; position: absolute" Text="Grand Total :    RS. "></asp:Label>
            <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Size="X-Large" style="font-weight: 700; z-index: 1; left: 413px; top: 205px; position: absolute" Text="0"></asp:Label>
